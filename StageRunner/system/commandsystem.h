...
enum VideoViewStatus {
	VIEW_UNUSED			= 0,
	VIEW_BLACK			= 1,			// 1
	VIEW_PRE_DELAY		= 1<<1,			// 2
	VIEW_HOLD			= 1<<2,			// 4
	VIEW_VIDEO_VISIBLE	= 1<<3,			// 8
	VIEW_VIDEO_FADEIN	= 1<<4,			// 16
	VIEW_VIDEO_FADEOUT	= 1<<5,			// 32
	VIEW_PIC_VISIBLE	= 1<<6,			// 64
	VIEW_PIC_FADEIN		= 1<<7,			// 128
	VIEW_PIC_FADEOUT	= 1<<8,			// 256
	VIEW_FADE_STOPPED	= 1<<9,			// 512
