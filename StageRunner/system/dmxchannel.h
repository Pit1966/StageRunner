...
public:
	...
	qint32 curValue;					///< current output value (0 - targetFullRange) HTP with directValue
	qint32 directValue;					///< current output value derived from direct fade (input connection) HTP with curValue
