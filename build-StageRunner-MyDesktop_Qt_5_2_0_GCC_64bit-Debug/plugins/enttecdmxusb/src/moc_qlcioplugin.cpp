...
#include "../../../../StageRunner/plugins/interfaces/qlcioplugin.h"
...
struct qt_meta_stringdata_QLCIOPlugin_t {
    QByteArrayData data[7];
    char stringdata[68];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_QLCIOPlugin_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_QLCIOPlugin_t qt_meta_stringdata_QLCIOPlugin = {
    {
...
QT_MOC_LITERAL(6, 46, 20)
    },
    "QLCIOPlugin\0valueChanged\0\0input\0channel\0"
    "value\0configurationChanged\0"
};
...
void QLCIOPlugin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (QLCIOPlugin::*_t)(quint32 , quint32 , uchar );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QLCIOPlugin::valueChanged)) {
                *result = 0;
            }
        }
        {
            typedef void (QLCIOPlugin::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QLCIOPlugin::configurationChanged)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject QLCIOPlugin::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QLCIOPlugin.data,
      qt_meta_data_QLCIOPlugin,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QLCIOPlugin.stringdata))
...
// SIGNAL 0
void QLCIOPlugin::valueChanged(quint32 _t1, quint32 _t2, uchar _t3)
{
